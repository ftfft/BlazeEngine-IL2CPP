...
namespace BE4v.SDK.CPP2IL
{
    public class IL2Field : IL2Base
    {
        ...
        public IL2ClassType ReturnType => new IL2ClassType(Import.Field.il2cpp_field_get_type(ptr));
        public int Token => Import.Field.il2cpp_field_get_offset(ptr);
        ...
        public IL2Class ReflectedType => new IL2Class(Import.Field.il2cpp_field_get_parent(ptr));
