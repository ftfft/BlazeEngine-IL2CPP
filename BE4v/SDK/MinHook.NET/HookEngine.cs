...
namespace MinHook
{
    public sealed class HookEngine : IDisposable
    {
        ...
        */
        ...
        public IntPtr CreateHookW(IntPtr target, Delegate detour)
        {
            ...
            {
                var hook = new Hook(target, Marshal.GetFunctionPointerForDelegate(detour), memoryAllocator.AllocateBuffer(target));
                Delegate original = Marshal.GetDelegateForFunctionPointer(hook.Original, typeof(Delegate));
                originalHookMapping.Add(original, hook);
        ...
        public IntPtr CreateHook(IntPtr target, Delegate detour)
        {
