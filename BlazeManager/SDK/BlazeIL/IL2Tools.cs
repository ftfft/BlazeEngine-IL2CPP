...
namespace BlazeIL
{
    ...
    public static class IL2Tools
    {
        public static T MonoCast<T>(this IntPtr ptr)
        {
            ...
            else if (BlazeTools.Types.otherUnmanagedTypes.Contains(typeof(T)))
            {
                unsafe
                {
                    ...
                    if (typeof(T) == typeof(UnityEngine.LayerMask))
                        return (T)(object)ptr.Unbox<UnityEngine.LayerMask>();
                    // Steamworks.SteamId
                    if (typeof(T) == typeof(Steamworks.SteamId))
                        return (T)(object)ptr.Unbox<Steamworks.SteamId>();
                }
            }
        ...
        unsafe private static T Unbox<T>(this IntPtr ptr) where T : unmanaged => *(T*)(ptr + 0x10).ToPointer();
        ...
        unsafe public static T pUnbox<T>(this IntPtr obj) where T : unmanaged => *(T*)&obj;
        ...
        unsafe public static T[] IntPtrToStructureArray<T>(IntPtr ptr) => IntPtrToStructureArray<T>(ptr, *((uint*)ptr + 3));
