...
namespace VRCSDK2
{
    unsafe public class VRC_EventHandler : Component
    {
        ...
        public static bool BooleanOp(VRC_EventHandler.VrcBooleanOp Op, bool Current)
        {
            ...
            return *(bool*)methodBooleanOp.Invoke(IntPtr.Zero, new IntPtr[] { new IntPtr(&Op), new IntPtr(&Current) }).Unbox();
        }
        ...
        public int NetworkID
        {
            get
            {
                ...
                return *(int*)propertyNetworkID.GetGetMethod().Invoke(ptr, new IntPtr[0]).Unbox();
            }
            set
            {
                if (propertyNetworkID == null)
        ...
        public class VrcEvent : IL2Base
        {
            ...
            public string Name
            {
                get
                {
                    ...
                    return fieldName.GetValue(ptr).UnboxString();
                }
                set
                {
                    if (fieldName == null)
            ...
            public VrcEventType EventType
            {
                get
                {
                    ...
                    return *(VrcEventType*)fieldEventType.GetValue(ptr).Unbox();
                }
                set
                {
                    if (fieldEventType == null)
            ...
            public string ParameterString
            {
                get
                {
                    ...
                    return fieldParameterString.GetValue(ptr).UnboxString();
                }
                set
                {
                    if (fieldParameterString == null)
            ...
            public VrcBooleanOp ParameterBoolOp
            {
                get
                {
                    ...
                    return *(VrcBooleanOp*)fieldParameterBoolOp.GetValue(ptr).Unbox();
                }
                set
                {
                    if (fieldParameterBoolOp == null)
            ...
            public bool ParameterBool
            {
                get
                {
                    ...
                    return *(bool*)fieldParameterBool.GetValue(ptr).Unbox();
                }
                set
                {
                    if (fieldParameterBool == null)
            ...
            public float ParameterFloat
            {
                get
                {
                    ...
                    return *(float*)fieldParameterFloat.GetValue(ptr).Unbox();
                }
                set
                {
                    if (fieldParameterFloat == null)
            ...
            public int ParameterInt
            {
                get
                {
                    ...
                    return *(int*)fieldParameterInt.GetValue(ptr).Unbox();
                }
                set
                {
                    if (fieldParameterInt == null)
            ...
            public GameObject[] ParameterObjects
            {
                get
                {
                    ...
                    var result = fieldParameterObjects.GetValue(ptr).ptr.IntPtrToArray();
                    GameObject[] pointerArray = new GameObject[result.Length];
                    for (int i = 0; i < result.Length; i++)
                        pointerArray[i] = result[i].MonoCast<GameObject>();
                    return pointerArray;
                }
                set
                {
            ...
            public byte[] ParameterBytes
            {
                get
                {
                    ...
                    var result = fieldParameterBytes.GetValue(ptr).ptr.IntPtrToArray();
                    byte[] pointerArray = new byte[result.Length];
                    for (int i = 0; i < result.Length; i++)
                    {
                        pointerArray[i] = (byte)IL2Import.il2cpp_object_unbox(result[i]).ToPointer();
                    }
                    return pointerArray;
                }
                set
            ...
            public bool TakeOwnershipOfTarget
            {
                get
                {
                    ...
                    return *(bool*)fieldTakeOwnershipOfTarget.GetValue(ptr).Unbox();
                }
                set
                {
                    if (fieldTakeOwnershipOfTarget == null)
        ...
        {
            if (obj.GetType() != typeof(VRC_EventHandler))
                return false;
            return ((VRC_EventHandler)obj).ptr == ptr;
        }
        ...
        private static IL2Type Instance = Assemblies.a["VRCSDK2"].GetClass("VRC_EventHandler", "VRCSDK2");
    }
}