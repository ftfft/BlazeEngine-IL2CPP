...
namespace NET_SDK
{
    internal static class SDK_FileInfo
    {
        public const string Name = "NET SDK";
    ...
    public static class IL2CPP
    {
        ...
        public extern static uint vrcloader_get_net_mod_count();
        [DllImport("winmm", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public extern static string vrcloader_get_net_mod(uint index); */
