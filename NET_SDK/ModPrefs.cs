...
namespace NET_SDK
{
    internal static class ModPrefsController
    {
        ...
        public static void SetString(string section, string name, string value) { Instance.IniWriteValue(section, name, value.Trim()); }
        ...
        public static void SetInt(string section, string name, int value) { Instance.IniWriteValue(section, name, value.ToString()); }
        ...
        public static void SetFloat(string section, string name, float value) { Instance.IniWriteValue(section, name, value.ToString()); }
        ...
        public static void SetBool(string section, string name, bool value) { Instance.IniWriteValue(section, name, value ? "true" : "false"); }

        public static bool HasKey(string section, string name) { return Instance.IniReadValue(section, name) != null; }
    }
    ...
    public static class ModPrefs
    {
        ...
        public static void SaveConfig()
        {
            ...
            NET_SDK.ModLoader.Main.OnModSettingsApplied();
