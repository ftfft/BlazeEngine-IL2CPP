...
public class Logger
{
    ...
    private static string fileprefix = "NET_SDK_";
    ...
    public static void Log(string s)
    {
        ...
        if(consoleEnabled) Console.WriteLine("[" + timestamp + "] [NET_SDK] " + s);
    ...
    public static void Log(string s, params object[] args)
    {
        ...
        if (consoleEnabled) Console.WriteLine("[" + timestamp + "] [NET_SDK] " + s, args);
    ...
    {
        var timestamp = GetTimestamp();
        if (consoleEnabled) Console.WriteLine("[" + timestamp + "] [NET_SDK] [Error] " + s);
    ...
    public static void LogError(string s, params object[] args)
    {
        var timestamp = GetTimestamp();
        var formatted = string.Format(s, args);
        if (consoleEnabled) Console.WriteLine("[" + timestamp + "] [NET_SDK] [Error] " + formatted);
