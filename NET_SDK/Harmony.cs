...
namespace NET_SDK.Harmony
{
    ...
    public class Patch
    {
        ...
        public IL2CPP_Object InvokeOriginal(params IntPtr[] paramtbl)
        {
        ...
        public IL2CPP_Object InvokeOriginal(params IL2CPP_Object[] paramtbl)
        {
            if (paramtbl.Length == 1)
                return InvokeOriginal(paramtbl[0]);
            else
                return InvokeOriginal(IntPtr.Zero, IL2CPP.IL2CPPObjectArrayToIntPtrArray(paramtbl));
        }
