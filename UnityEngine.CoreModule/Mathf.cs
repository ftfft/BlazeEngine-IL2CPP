...
/*
        ...
        */
        ...
        public static float GammaToLinearSpace(float value)
        {
            ...
            result = methodGammaToLinearSpace.Invoke(new IntPtr[] { new IntPtr(&value) });
            if (result == null)
                return default;
        ...
        public static float LinearToGammaSpace(float value)
        {
            ...
            IL2Object result = null;
            result = methodLinearToGammaSpace.Invoke(new IntPtr[] { new IntPtr(&value) });
            if (result == null)
                return default;
            return *(float*)result.Unbox();
        }
