...
namespace BlazeIL
{
    unsafe public static class IL2Import
    {
        ...
        public static IntPtr[] IL2CPPObjectArrayToIntPtrArray(IL2Object[] objtbl) { IntPtr[] arr = new IntPtr[objtbl.Length]; for (uint i = 0; i < objtbl.Length; i++) { arr[i] = objtbl[i].ptr; }; return arr; }
