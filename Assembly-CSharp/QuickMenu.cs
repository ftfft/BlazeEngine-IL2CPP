...
unsafe public class QuickMenu : Component
{
    ...
    public static QuickMenu Instance
    {
        get
        {
            ...
            return result.ptr.MonoCast<QuickMenu>();
        }
    }
    ...
    public APIUser SelectedUser
    {
        get
        {
            ...
            IL2Object result = propertySelectedUser.GetGetMethod().Invoke(ptr);
            if (result == null)
                return null;
    ...
    public GameObject _currentMenu
    {
        get
        {
            ...
            {
                fieldCurrentMenu = Instance_Class.GetFields().First(x => x.token == 0x108);
                if (fieldCurrentMenu == null)
                    return null;
            }
            IL2Object result = fieldCurrentMenu.GetValue(ptr);
            if (result == null)
                return null;
    ...
    {
        if (obj.GetType() != typeof(QuickMenu))
            return false;
        return ((QuickMenu)obj).ptr == ptr;
    }
